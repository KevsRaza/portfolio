        ...
        <div class="w-full px-5 sm:px-8 md:px-12 lg-px-8 max-w-5xl lg:max-w-7xl mx-auto relative z-10">
            <div class="grid lg:grid-cols-2 gap-10 xl:gap-14 items-center">
                <div class="flex flex-col md:mt-0 mt-20 justify-center">
                    <div class="text-white lg:text-left" data-aos="fade-right">
                        <h1 class="text-white font-bold text-4xl md:text-5xl lg:text-6xl leading-tight">
                            Hi, I'm Kevin
                            <span
                                class="text-transparent bg-clip-text bg-linear-to-r from-blue-400 to-cyan-400">RAZAFINDRALANTO</span>
                        </h1>
                    ...
                    <div class="flex items-center gap-4 pt-8 flex-col sm:flex-row sm:w-max sm:mx-auto lg:mx-0"
                        ...
                        <a href="#contact" class="px-8 md:px-10 py-4 rounded-xl relative group w-full sm:w-max
                        ...
                        <a href="#" download class="border-2 border-blue-400 px-8 md:px-10 py-4 rounded-xl relative group
                        w-full sm:w-max flex justify-center
                        hover:bg-blue-400/10 transition-all duration-300">
                            <div class="flex items-center justify-center relative">
                                <ArrowDownTrayIcon
                                    class="w-5 h-5 text-blue-400 group-hover:translate-y-1 transition-transform" />
                ...
                <div class="lg:h-full flex justify-center lg:justify-end">
                    <div class="relative z-10 bg-linear-to-r from-blue-600 to-cyan-600 shadow-2xl rounded-[50%_40%_30%_60%/60%_30%_70%_30%] p-4 backdrop-blur-sm border border-blue-500/30 -translate-y-6 overflow-hidden"
                        data-aos="zoom-in" data-aos-delay="500">
                        <div class="rounded-xl overflow-hidden">
                            <img src="../assets/hero.png" alt="Kevin - Web Developer & DevOps Junior" loading="lazy"
                                class="w-[500px] h-[500px] object-cover object-center -translate-y-10">
                        </div>
                    </div>
                    <div
