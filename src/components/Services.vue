        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mt-16" data-aos="fade-up" data-aos-delay="800">
                <div class="inline-flex flex-col sm:flex-row gap-4 items-center">
                    <a href="#contact" class="px-8 py-4 rounded-xl border-2 border-blue-400 text-blue-400 font-semibold
...
<script setup>
import { ArrowRightIcon, ChatBubbleLeftRightIcon, CodeBracketIcon, ShieldCheckIcon, RocketLaunchIcon } from '@heroicons/vue/16/solid';
import { ref } from 'vue';
